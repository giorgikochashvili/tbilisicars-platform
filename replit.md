...
- **Sidebar modules**: Dashboard, Bookings, Fleet (Vehicles/Models/Brands tabs), Customers, Locations, Extras, Rates, Promotions, Team
...
| GET | `/api/admin/fleet-calendar` | Fleet calendar (dateFrom/dateTo) |
