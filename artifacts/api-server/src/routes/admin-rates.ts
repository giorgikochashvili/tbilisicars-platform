...
router.post("/admin/rates", requireAdmin, requirePermission("canManageRates"), async (req, res) => {
...
router.patch("/admin/rates/:id", requireAdmin, requirePermission("canManageRates"), async (req, res) => {
...
router.post("/admin/rates/:id/tiers", requireAdmin, requirePermission("canManageRates"), async (req, res) => {
...
router.patch("/admin/rates/:id/tiers/:tierId", requireAdmin, requirePermission("canManageRates"), async (req, res) => {
...
router.delete("/admin/rates/:id/tiers/:tierId", requireAdmin, requirePermission("canManageRates"), async (req, res) => {
