...
function SummaryCards({ summary, onFilter }: { summary: Summary; onFilter: (t: AlertType) => void }) {
  const tiles = [
    ...
    { key: "DELIVERED_NO_PAYMENT" as AlertType, label: "No Pmt Record", count: summary.deliveredNoPayment ?? 0, cls: "border-red-500/30 bg-red-500/5 text-red-400", icon: <CreditCard className="w-5 h-5" /> },
