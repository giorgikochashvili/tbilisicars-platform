      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3">
            <a href="tel:+995595286600" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-white transition-colors">
              <Phone className="w-4 h-4 text-primary shrink-0" />+995 595 28 66 00
            </a>
            <a href="https://wa.me/995595286600" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-white transition-colors">
            ...
            <a href="https://share.google/lbXYIFHqGODm91fdk" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-white transition-colors">
              <MapPin className="w-4 h-4 text-primary shrink-0" />Kutaisi Airport Office
            </a>
