...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[hsl(211,55%,8%)] border-b border-border shadow-lg">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-3 shrink-0">
            ...
            <div className="leading-none">
              <div className="font-bold text-white text-lg tracking-tight">Tbilisi Cars</div>
